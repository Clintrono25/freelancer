...
const PricePlan = ({navigation,route}) => {
  ...
  const buyPackage = (id) => {
    ...
    axios
    .post(Constant.BaseUrl + "dashboard/create_checkout_page", {
    ...
    return (
      <View style={styles.pricePlanMainView}>
        ...
        <View style={{alignItems: 'center', justifyContent: 'center'}}>
          ...
          <Text style={styles.pricePlanNameDesc}>
           {item.tagline}
          </Text>
        </View>
    ...
    <SafeAreaView style={styles.globalContainer}>
      ...
      {loader ? (
        ...
        <View style={styles.cardView}>
          <Text style={styles.pricePlanHeading}>{Translation.pricePlanHeading}</Text>
