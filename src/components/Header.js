          ...
          <View
            ...
            <TouchableOpacity
              ...
              style={{
                ...
                marginTop: 10,
                backgroundColor:
                  searchType == 'freelancer' ? Constant.whiteColor : '#F7F8FC',
                paddingVertical: 10,
            ...
            {settings.user_meta.access_type.job_access == "yes" &&
              ...
              style={{
                ...
                marginTop: 10,
                backgroundColor:
                  searchType == 'jobs' ? Constant.whiteColor : '#F7F8FC',
                paddingVertical: 10,
                paddingHorizontal: 10,
                borderRadius: 10,
                borderWidth: 1,
            ...
            <TouchableOpacity
              ...
              style={{
                ...
                marginTop: 10,
                backgroundColor:
                  searchType == 'employers' ? Constant.whiteColor : '#F7F8FC',
                paddingVertical: 10,
                paddingHorizontal: 10,
                borderRadius: 10,
                borderWidth: 1,
           ...
           {settings.user_meta.access_type.service_access == "yes" &&
            <TouchableOpacity
              ...
              style={{
                ...
                marginTop: 10,
                backgroundColor:
                  searchType == 'services' ? Constant.whiteColor : '#F7F8FC',
                paddingVertical: 10,
                paddingHorizontal: 10,
                borderRadius: 10,
                borderWidth: 1,
