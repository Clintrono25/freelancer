    ...
    <SafeAreaView style={styles.globalContainer}>
      ...
      <View
        ...
        <View style={styles.rowView}>
          {loader ? (
            ...
            <>
              <TouchableOpacity onPress={() => token!= null ?  saveJob(): openLoginAlert()}>
                {jobDetail.favourite == 'yes' ? (
                  <AntDesign
          ...
          <View style={styles.jobCardInfoListMain}>
            ...
            <Text style={styles.jobCardInfoListHeadingValue}>
              {jobDetail.proposal_count <= 1
                ...
                : jobDetail.proposal_count + Translation.jobDetailProposals}
            </Text>
          </View>
          ...
          <View
            ...
            <TouchableOpacity
              onPress={() => {
                setReasonValue(null);
                setDetail('');
                token != null ? RBSheetReportProject.current.open() :openLoginAlert();
              }}
              style={{
      ...
      <RBSheet
        ...
        <View style={styles.RBSheetMainView}>
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            <Text style={styles.inputHeading}>{Translation.jobDetailReason}</Text>
            <DropDownPicker
            ...
            />
            <Text style={styles.inputHeading}>{Translation.jobDetailDescription}</Text>
