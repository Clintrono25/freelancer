      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.cardView}>
         ...
         <> */}
          ...
          {settings.project_settings.job_experience_option.gadget ==
            ...
            <>
              ...
              <DropDownPicker
                ...
                badgeDotColors={['#e76f51']}
              />
              <Text style={styles.inputHeading}>{Translation.postJobExpiredDate}</Text>
              <FormInput
          ...
          <Text style={styles.inputHeading}>{Translation.postJobUploadRelevantProjectFiles}</Text>
          ...
          {settings.project_settings.job_faq_option == 'yes' && (
            <>
              <View style={[styles.rowView, {justifyContent: 'space-between'}]}>
                <Text style={styles.inputHeading}>{Translation.postJobServiceFAQ}</Text>
                {showFAQ == false ? (
