...
const ProfileSetting = () => {
  ...
  const [tabs, setTabs] = useState([
    ...
    {name: settings.freelancers_settings.freelancer_social_profile_settings.gadget == "enable" ? Translation.profileSettingTabSocialProfiles : ""},
  ...
  const [employerTabs, setEmployerTabs] = useState([
    ...
    {name: settings.employers_settings.employer_social_profile_settings.gadget == "enable" ? Translation.profileSettingTabSocialProfiles : ""},
  ]);
  ...
  const getProfileData = async () => {
    return fetch(Constant.BaseUrl + 'profile/setting?id=' + userInfo.id, {
      ...
      .then(responseJson => {
        // console.log('response Profile Data', responseJson);
        ...
        setFreelancerTypeValue(responseJson.freelancer_types);
        ...
        setGallery(responseJson.freelancer_gallery);
  ...
  const getEmployeeProfileData = async () => {
    return fetch(
      ...
      .then(response => response.json())
      .then(responseJson => {
        // console.log('response EMPProfile Data', responseJson);
  ...
  const saveUpdatePersonalDataFreelancer = () => {
    ...
    basics.push({
      ...
      content: detail,
      gender: genderValue,
      resume_base64: resume != null ? resume.hasOwnProperty('document_name')
      ? {}
      : {
          name:
            Platform.OS == 'ios'
  ...
  const saveUpdateSocialProfile = async () => {
    ...
    console.log("first",socialObj)
    setLoading(true);
    axios
      .post(
        Constant.BaseUrl + 'profile/update_social_profile_setting?user_id='+ userInfo.id,
        {
          id:userInfo.id,
          basics: socialObj,
        },
  ...
  const saveUpdateBrouchers = () => {
    ...
    axios
      .post(
        Constant.BaseUrl + 'profile/update_brochures_setting',
        formData,
        {
          headers: {
            'Content-Type': 'multipart/form-data',
  ...
  const saveUpdateProject = async () => {
      ...
      if (projects[i].hasOwnProperty('image')) {
        projectsArray.push({
          ...
          image0: {
            // uri:
            //   Platform.OS == 'ios'
            //     ? projects[i].image.sourceURL
            //     : projects[i].image.path,
            name:
              Platform.OS == 'ios'
                ? projects[i].image.filename
                : projects[i].image.path.substring(
                    projects[i].image.path.lastIndexOf('/') + 1,
                  ),
            type: projects[i].image.mime,
            base64_string: projects[i].image.data,
          },
        });
      } else {
        projectsArray.push({
    ...
    axios
      .post(
        Constant.BaseUrl +
          'profile/update_tab_settings?user_id=' +
          userInfo.id +
          '&edit_type=' +
          'projects',
        {
      ...
      if (awards[i].hasOwnProperty('image')) {
        awardsArray.push({
          ...
          image0: {
            // uri:
            //   Platform.OS == 'ios'
            //     ? awards[i].image.sourceURL
            //     : awards[i].image.path,
            name:
              Platform.OS == 'ios'
                ? awards[i].image.filename
                : awards[i].image.path.substring(
                    awards[i].image.path.lastIndexOf('/') + 1,
                  ),
            type: awards[i].image.mime,
            base64_string: awards[i].image.data,
          },
        });
      } else {
        awardsArray.push({
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <View style={[styles.cardView, {paddingTop: 5}]}>
              <View style={styles.profileSettingImageView}>
                <ImageBackground
                  ...
                  source={bannerPhoto != null ?
                    bannerPhoto.hasOwnProperty('banner_image_url')
                      ?bannerPhoto.banner_image_url != "" ? {uri: bannerPhoto.banner_image_url}
                      :
                  ...
                  <View
                    ...
                    <TouchableOpacity
                      ...
                      <Feather name="edit-3" color={'#fff'} size={24} />
                    </TouchableOpacity>
                  </View>
                </ImageBackground>
              ...
              <View style={{flexDirection:"row",marginLeft: 20, marginTop: -60,alignItems:"center"}}>
              <View style={{width: 70,
                    height: 70,borderRadius: 70 / 2,alignItems:"center",justifyContent:"center",backgroundColor:Constant.whiteColor}}>
                <Image
                  style={{
                    width: 65,
                    height: 65,
                  ...
                  source={
                    photo.hasOwnProperty('image_url')
                      ?
                      photo.image_url != "" ? {uri: photo.image_url}
                      :
                      require("../../assets/images/NoImage.png") 
                      : {
                          uri:
                            Platform.OS == 'ios' ? photo.sourceURL : photo.path,
                        }
                  }
                />
                </View>
              ...
              <FormInput
                ...
                placeholderText={Translation.profileSettingDisplayNamePlaceholder}
                keyboardType="email-address"
                autoCorrect={false}
              />
              {profileInfo.user_type == 'freelancer' && (
                <>
                  ...
                  <FormInput
                    ...
                    placeholderText={Translation.profileSettingHourlyRatePlaceholder}
                    keyboardType="email-address"
                    autoCorrect={false}
                  />
                  <Text style={styles.inputHeading}>
                  ...
                  <FormInput
                    ...
                    placeholderText={Translation.profileSettingMaximumHourRatePlaceholder}
                    keyboardType="email-address"
                    autoCorrect={false}
                  />
                </>
              ...
              <FormInput
                ...
                placeholderText={Translation.profileSettingPhoneNumberPlaceholder}
                keyboardType="email-address"
                autoCorrect={false}
              />
              <Text style={styles.inputHeading}>
              ...
              />
                {profileInfo.user_type == 'employer' && (
                   <>
              {settings.employers_settings.company_job_title == "enable" &&
              <>
               <Text style={styles.inputHeading}>
              ...
              <FormInput
                ...
                placeholderText={Translation.profileSettingCompanyNamePlaceholder}
                keyboardType="email-address"
                autoCorrect={false}
              />
              </>}
              ...
              <Text style={styles.inputHeading}>{Translation.profileSettingAddDescription}</Text>
              <View style={styles.multilineTextInputView}>
                <TextInput
                  placeholder={Translation.profileSettingAddDescriptionPlaceholder}
                  multiline
                  value={detail}
              ...
              {profileInfo.user_type == 'freelancer' && (
                <>
                  <Text
                    ...
                    onPress={() => console.log(languageValue)}>
              ...
              {profileInfo.user_type == 'employer' && (
                <>
                  <Text style={styles.inputHeading}>{Translation.profileSettingCompanyDetails}</Text>
              ...
              {profileInfo.user_type == 'freelancer' && (
                <>
                  <Text style={styles.inputHeading}>{Translation.profileSettingUploadResume}</Text>
              ...
              <FormInput
                ...
                placeholderText={Translation.profileSettingYourAddressPlaceholder}
                keyboardType="email-address"
                autoCorrect={false}
                iconType={'crosshair'}
              ...
              {profileInfo.user_type == 'freelancer' && (
                <>
                  <View
                    ...
                    <Text style={styles.inputHeading}>{Translation.profileSettingMySkills}</Text>
                    <TouchableOpacity
                    ...
                    <>
                      ...
                      <View
                        ...
                        <FormInput
                          ...
                          placeholderText={Translation.profileSettingAddValuePlaceholder}
                          keyboardType="email-address"
                          autoCorrect={false}
                        />
                        <View
              ...
              <FormButton
                onPress={() => profileInfo.user_type == 'freelancer' ? saveUpdatePersonalDataFreelancer() : saveUpdatePersonalDataEmployer() }
          ...
          {profileInfo.user_type != 'employer' ? (
                      ...
                      <>
                        ...
                        <View
                          ...
                          <FormInput
                            ...
                            placeholderText={Translation.profileSettingExperiencePlaceholder}
                            keyboardType="email-address"
                            autoCorrect={false}
                          />
                          <Text style={styles.inputHeading}>
                          ...
                          <FormInput
                            ...
                            placeholderText={Translation.profileSettingStartDate}
                            keyboardType="email-address"
                            editable={false}
                            autoCorrect={false}
                            iconType={'calendar'}
                          ...
                          <FormInput
                            ...
                            placeholderText={Translation.profileSettingCompanyPlaceholder}
                            keyboardType="email-address"
                            autoCorrect={false}
                          />
                          <Text style={styles.inputHeading}>
                      ...
                      <>
                        ...
                        <View
                          ...
                          <FormInput
                            ...
                            placeholderText={Translation.profileSettingDegreePlaceholder}
                            keyboardType="email-address"
                            autoCorrect={false}
                          />
                          <Text style={styles.inputHeading}>
            ...
            <>
              {selectedSection == 1 && (
                <View style={styles.cardView}>
                  <Text style={styles.inputHeading}>{Translation.profileSettingUploadBrochures}</Text>
                  <View
                    style={[
                      ...
                      <View
                        ...
                        <View style={{marginLeft: 10,width:"85%"}}>
                          ...
                          <Text
                            ...
                            {Translation.profileSettingFileSize}{item.hasOwnProperty("attachment_id") ? item.size : (item.size/1024).toFixed(2) +" KB"}
                          </Text>
                        </View>
                        <Feather
          ...
          {selectedSection == 2 && (
            <>
              <View style={styles.cardView}>
                <Text style={styles.inputHeading}>{Translation.profileSettingSocialProfileItems}</Text>
                <FlatList
                    showsVerticalScrollIndicator={false}
                    data={socialMedia}
                    ...
                    <FormInput
                      ...
                      onChangeText={text => {socialMedia[index].social_url = text
                      setRefreshList(!refreshList)}}
          ...
          {selectedSection == 3 && (
            <>
              <View style={styles.cardView}>
                <Text style={styles.inputHeading}>{Translation.profileSettingGalleryPhoto}</Text>
                <View
                  style={[
                    styles.uploadFileView,
                    {
          ...
          {selectedSection == 4 && (
            <View style={styles.cardView}>
              <View style={[styles.rowView, {justifyContent: 'space-between'}]}>
                <Text style={styles.inputHeading}>{Translation.profileSettingAddYourProjects}</Text>
                ...
                <>
                          ...
                          source={
                            projects[projectIndex].hasOwnProperty('image')
                              ? {
                                  uri:
                                    Platform.OS == 'ios'
                                      ? projects[projectIndex].image.sourceURL
                                      : projects[projectIndex].image.path,
                                }
                  ...
                  <View
                    ...
                    <FormInput
                      ...
                      placeholderText={Translation.profileSettingProjectPlaceholder}
                      keyboardType="email-address"
                      autoCorrect={false}
                    />
                    <Text style={styles.inputHeading}>
                    ...
                    <FormInput
                      ...
                      autoCorrect={false}
                    />
                    <Text style={styles.inputHeading}>{Translation.profileSettingFileUpload}</Text>
                    <View
                      style={[
                        styles.uploadFileView,
                        {
                      ...
                      <FormButton
                        onPress={() => choosePictureFromGallery('projects')}
                        buttonTitle={Translation.globalSelectFile}
                        backgroundColor={Constant.greenColor}
                        textColor={Constant.whiteColor}
                      />
                    ...
                    {projectImage != null && (
                      <View
                        ...
                        <Text style={styles.JobDetailAttachmentItemText}>
                          {projectImage.hasOwnProperty('filename')
          ...
          {selectedSection == 5 && (
            <View style={styles.cardView}>
              <View style={[styles.rowView, {justifyContent: 'space-between'}]}>
                <Text style={styles.inputHeading}>{Translation.profileSettingAwardCertifications}</Text>
                ...
                <>
                          ...
                          source={
                            awards[awardIndex].hasOwnProperty('image')
                              ? {
                                  uri:
                                    Platform.OS == 'ios'
                                      ? awards[awardIndex].image.sourceURL
                                      : awards[awardIndex].image.path,
                                }
                  ...
                  <View
                    ...
                    <FormInput
                      ...
                      iconColor={Constant.lightGrayColor}
                    />
                    <Text style={styles.inputHeading}>{Translation.profileSettingUploadPhoto}</Text>
                    <View
                      style={[
                        styles.uploadFileView,
                        {
                      ...
                      <FormButton
                        onPress={() => choosePictureFromGallery('awards')}
                        buttonTitle={Translation.globalSelectFile}
                        backgroundColor={Constant.greenColor}
                        textColor={Constant.whiteColor}
                      />
                    ...
                    {awardImage != null && (
                      <View
                        ...
                        <Text style={styles.JobDetailAttachmentItemText}>
                          {awardImage.hasOwnProperty('filename')
                            ? awardImage.filename
          ...
          {selectedSection == 6 && (
            <View style={styles.cardView}>
              <View style={[styles.rowView, {justifyContent: 'space-between'}]}>
                <Text style={styles.inputHeading}>{Translation.profileSettingAddYourVideos}</Text>
          ...
          {selectedSection == 7 && (
            <View style={styles.cardView}>
              <View style={[styles.rowView, {justifyContent: 'space-between'}]}>
                <Text style={styles.inputHeading}>{Translation.profileSettingSpecializations}</Text>
                <TouchableOpacity
                ...
                <>
                  ...
                  <View
                    ...
                    <FormInput
                      ...
                      placeholderText={Translation.profileSettingAddPercentagePlacholder}
                      keyboardType="email-address"
                      autoCorrect={false}
                    />
                    <View
          ...
          {selectedSection == 9 && (
            <View style={styles.cardView}>
              <View style={[styles.rowView, {justifyContent: 'space-between'}]}>
                <Text style={styles.inputHeading}>{Translation.profileSettingFAQlist}</Text>
                ...
                <>
                  ...
                  <View
                    ...
                    <FormInput
                      ...
                      placeholderText={Translation.profileSettingQuestionPlaceholder}
                      keyboardType="email-address"
                      autoCorrect={false}
                    />
                    <Text style={styles.inputHeading}>
                    ...
                    <View style={styles.multilineTextInputView}>
                      <TextInput
                        placeholder={Translation.profileSettingAnswerPlaceholder}
                        multiline
                        value={answer}
