...
const ServiceDetail = ({navigation, route}) => {
  ...
  const onClickShare = () => {
    Share.share(
      {
        message: 'Share the link',
        url: serviceDetail.freelancer_link,
        title: 'Share Service',
      },
      {
        // Android only:
        dialogTitle: serviceDetail.freelancer_link,
        // iOS only:
    ...
    <SafeAreaView style={styles.globalContainer}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.cardView}>
          ...
          <View style={styles.serviceDetailAboutSectionParentStyle}>
            <View
              style={{
                flexDirection: 'row',
