...
const customDrawer = ({navigation}) => {
  ...
  const getSingleFreelancer = async () => {
    ...
    return fetch(
      ...
      .then(response => response.json())
      .then(responseJson => {
        // console.log('responseMyProfile', responseJson);
        if (responseJson.type == 'success') {
          ...
          <View style={styles.drawerHeaderParentContentStyle}>
            ...
            {settings.switch_account == 'yes' && (
              <TouchableOpacity
                ...
                {loading == true ? (
                  <View>
                    <BallIndicator color="#1C1C1C" size={14} />
                  </View>
                ) : (
                  <Feather name={'user'} size={18} color={'#1C1C1C'} />
                )}
              </TouchableOpacity>
            )}
          </View>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        {!isEmpty && (
          <>
            <TouchableOpacity
              ...
              <Feather name={'home'} size={18} color={'#1C1C1C'} />
            ...
            <TouchableOpacity
              ...
              style={[styles.drawerItemParentStyle, styles.drawerAddonStyle]}>
              <Feather name={'sliders'} size={18} color={'#1C1C1C'} />
              <Text style={styles.drawerItemTextStyle}>
            ...
            <TouchableOpacity
              ...
              <View style={{flexDirection: 'row', alignItems: 'center'}}>
                <Feather name={'monitor'} size={18} color={'#1C1C1C'} />
                <Text style={styles.drawerItemTextStyle}>
            ...
            <TouchableOpacity
              ...
              <View style={styles.drawerDropdownItemParentStyle}>
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                  <Feather name={'settings'} size={18} color={'#1C1C1C'} />
            ...
            {profileInfo.user_type == 'freelancer' && (
              <TouchableOpacity
                ...
                <View style={styles.drawerDropdownItemParentStyle}>
                  <View style={{flexDirection: 'row', alignItems: 'center'}}>
                    <Feather name={'edit'} size={18} color={'#1C1C1C'} />
                    <Text style={styles.drawerItemTextStyle}>
            ...
            {settings.remove_saved == 'no' && (
              <TouchableOpacity
                ...
                style={[styles.drawerItemParentStyle, styles.drawerAddonStyle]}>
                <Feather name={'heart'} size={18} color={'#1C1C1C'} />
                <Text style={styles.drawerItemTextStyle}>
            ...
            <TouchableOpacity
              ...
              style={[styles.drawerItemParentStyle, styles.drawerAddonStyle]}>
              <Feather name={'file'} size={18} color={'#1C1C1C'} />
              <Text style={styles.drawerItemTextStyle}>
            ...
            <TouchableOpacity
              ...
              style={[styles.drawerItemParentStyle, styles.drawerAddonStyle]}>
              <Feather name={'shield'} size={18} color={'#1C1C1C'} />
              <Text style={styles.drawerItemTextStyle}>
        ...
        {isEmpty && (
          <>
            <TouchableOpacity
              ...
              style={[styles.drawerItemParentStyle, styles.drawerAddonStyle]}>
              <Feather name={'log-in'} size={18} color={'#1C1C1C'} />
              <Text style={styles.drawerItemTextStyle}>{Translation.globalLogin}</Text>
            </TouchableOpacity>
            ...
            {settings.registration_option == 'enable' && (
              <TouchableOpacity
                ...
                style={[styles.drawerItemParentStyle, styles.drawerAddonStyle]}>
                <Feather name={'book'} size={18} color={'#1C1C1C'} />
                <Text style={styles.drawerItemTextStyle}>{Translation.customDrawerSignup}</Text>
              </TouchableOpacity>
            )}
          </>
        )}
        ...
        {settings.help_support.gadget == 'enable' && (
          <TouchableOpacity
            ...
            style={[styles.drawerItemParentStyle, styles.drawerAddonStyle]}>
            <Feather name={'headphones'} size={18} color={'#1C1C1C'} />
            <Text style={styles.drawerItemTextStyle}>{Translation.customDrawerHelp}</Text>
          </TouchableOpacity>
        )}
        ...
        {!isEmpty && (
          <>
            <TouchableOpacity
              ...
              style={[styles.drawerItemParentStyle, styles.drawerAddonStyle]}>
              <Feather name={'box'} size={18} color={'#1C1C1C'} />
              <Text style={styles.drawerItemTextStyle}>{Translation.customDrawerPackages}</Text>
            </TouchableOpacity>

            <TouchableOpacity
              onPress={() => logout()}
              style={[styles.drawerItemParentStyle, styles.drawerAddonStyle]}>
              <Feather name={'power'} size={18} color={'#1C1C1C'} />
              <Text style={styles.drawerItemTextStyle}>{Translation.customDrawerLogout}</Text>
            </TouchableOpacity>
          </>
        )}
      </ScrollView>
